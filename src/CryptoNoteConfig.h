...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1fc0;
...
const char     CRYPTONOTE_NAME[]                             = "Bandile";
...
const int      P2P_DEFAULT_PORT                              = 17222;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 18222;
